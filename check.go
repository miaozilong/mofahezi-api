...
func checkUpdate() {
	...
	//	根据校验文件判断要不要更新
	// 如果要更新,则下载更新文件
	md5Url := "https://upgrade-mofahezi.xiaolimofahezi.com/getUpdateMD5?deviceName=" + getHostName()
	upgradeFileUrl := "https://upgrade-mofahezi.xiaolimofahezi.com/getUpdateFile?deviceName=" + getHostName()
